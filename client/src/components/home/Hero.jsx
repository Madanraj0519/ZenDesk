...
const Hero = () => {
  return (
    <div className='mt-5 max-w-5xl mx-auto'>
        <div className='md:flex gap-5 md:py-10 px-4 md:px-0'>
            <div className='md:mt-10'>
             ...
             font-poppins font-medium text-lg rounded-full hover:bg-fuchsia-800 hover:border-white hover:text-zinc-100'>Sign In</button>
                    </Link>
                </div>
            </div>
